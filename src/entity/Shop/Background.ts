...
export class Background {
  ...
  @ManyToOne(type => BackgroundType, backgroundType => backgroundType.backgrounds)
  type: BackgroundType

  @OneToMany(type => BackgroundCategory, category => category.background)
  categories: BackgroundCategory[]

  @OneToMany(type => BackgroundTag, tag => tag.background)
  tags: BackgroundTag[]
}
